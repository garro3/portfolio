...
const About = () => {
  const stats = [
    ...
    },
    {
      icon: Coffee,
      value: "10+",
      label: "Weeks Intensive Bootcamp",
      color: "text-amber-600",
      bg: "bg-amber-50/80 dark:bg-amber-900/25",
    },
    {
      icon: Lightbulb,
      value: "∞",
      ...
      bg: "bg-violet-50/80 dark:bg-violet-900/25",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="grid gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="da-card rounded-2xl p-6 card-shadow hover:card-shadow-hover transition-all duration-300 hover:-translate-y-1"
              >
